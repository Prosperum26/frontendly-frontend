        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-6 mb-16">
          {stats.map((stat, index) => {
            ...
            return (
              <div
                key={index}
                className="cursor-pointer bg-white dark:bg-slate-800/80 backdrop-blur-sm rounded-2xl p-6 text-center border-2 border-slate-200 dark:border-slate-700 hover:border-cyan-300 dark:hover:border-cyan-500 transition-all duration-300 hover:scale-105 hover:shadow-xl hover:shadow-cyan-500/10 dark:hover:shadow-cyan-500/20"
              >
