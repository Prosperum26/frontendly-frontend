  ...
  return (
    <section className="py-20 bg-white dark:bg-slate-800">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
          {whyLearnHere.map((feature, index) => {
            ...
            return (
              <div
                key={index}
                className="group bg-gradient-to-br from-blue-50 to-purple-50 dark:from-slate-700 dark:to-slate-700 rounded-2xl p-6 hover:scale-105 hover:shadow-xl hover:shadow-blue-500/10 transition-all duration-300 cursor-pointer border-2 border-transparent hover:border-blue-300 dark:hover:border-blue-500"
              >
                <div className="w-14 h-14 bg-white dark:bg-slate-800 rounded-xl flex items-center justify-center mb-4 shadow-sm group-hover:scale-110 group-hover:rotate-3 transition-transform duration-300">
        ...
        {/* Bottom Banner */}
        <div className="mt-16 text-center bg-gradient-to-r from-gray-50 to-blue-50 dark:from-slate-700 dark:to-slate-700 rounded-3xl p-8 md:p-12">
          <h3 className="text-2xl font-bold text-heading dark:text-slate-100 mb-4">
            Ready to Transform Your Career?
          </h3>
          <p className="text-body dark:text-slate-300 mb-6 max-w-xl mx-auto">
