...
export function AiChatModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-end">
      ...
      <div className="relative w-full max-w-md h-[80vh] bg-white dark:bg-gray-900 shadow-2xl flex flex-col">
        {/* Header */}
        ...
        <div className="flex-1 overflow-y-auto px-6 py-4">
          ...
          {error && (
            <div className="bg-red-100 dark:bg-red-900/30 text-red-700 dark:text-red-400 rounded-lg px-4 py-3 text-sm mb-4">
              {error}
            </div>
          )}
