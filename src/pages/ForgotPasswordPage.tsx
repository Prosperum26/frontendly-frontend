        ...
        {!isSubmitted ? (
          <>
            ...
            <div className="text-center mb-8">
              <h1 className="text-2xl font-bold !text-heading">Quên mật khẩu</h1>
              <p className="text-sm text-muted mt-2 px-4">Nhập email của bạn để nhận link đặt lại mật khẩu</p>
            </div>

            <form onSubmit={handleSubmit} className="space-y-6">
              <div>
                <label className="block text-xs font-bold text-body mb-2 uppercase tracking-wide">Email address</label>
                <div className="relative">
                  ...
                  <input
                    ...
                    disabled={isLoading}
                    className="w-full pl-10 pr-3 py-2.5 border border-slate-300 rounded-lg text-sm focus:outline-none focus:border-blue-500 focus:ring-1 focus:ring-blue-500 disabled:bg-surface disabled:text-muted bg-surface"
                  />
                </div>
              </div>
          ...
          <>
            ...
            <div className="text-center">
              ...
              <h1 className="text-2xl font-bold !text-heading mb-3">Chúng tôi đã gửi email đặt lại mật khẩu</h1>
              <p className="text-sm text-muted mb-8 px-2">
                Please check your inbox. We have sent a secure link to reset your password.
              </p>

              <div className="bg-surface border border-border rounded-lg py-3.5 mb-8 flex items-center justify-center gap-2 text-sm text-body font-medium">
