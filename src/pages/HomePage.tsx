        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-6 sm:gap-8">
            ...
            <div className="bg-main-bg rounded-2xl border border-border p-6 sm:p-8 shadow-sm flex flex-col flex-1">
              ...
              <div className="flex flex-col gap-4 flex-1">
                ...
                <Link 
                  ...
                  className="group flex-1 flex flex-col items-center justify-center p-6 bg-surface-raised border border-border border-dashed rounded-xl hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors"
                >
          ...
          <div className="space-y-6 sm:space-y-8">
                ...
                <div className="space-y-3">
                  {challenges.slice(0, 3).map((challenge) => (
                    <Link
                      ...
                      className="block p-4 bg-surface-raised rounded-xl border border-border hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors "
                    >
            ...
            <div className="bg-main-bg rounded-2xl border border-border p-6 shadow-sm">
              ...
              <Link to={ROUTES.LEADERBOARD} className="w-full block text-center bg-surface-raised border border-border text-heading px-4 py-2.5 rounded-lg text-sm font-semibold hover:bg-slate-200 dark:hover:bg-slate-600 transition-colors">
                View Leaderboard
              </Link>
            </div>
