    ...
    <div className="min-h-screen bg-surface">
      <div className="max-w-7xl mx-auto px-6 py-8">
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4 mb-8">
          <div className="bg-main-bg rounded-xl p-6 shadow-sm border border-border">
            <p className="text-sm text-muted mb-2">XP EARNED</p>
            <p className="text-2xl font-bold text-blue-600">{user?.xp || 0}</p>
          </div>
          <div className="bg-main-bg rounded-xl p-6 shadow-sm border border-border">
            <p className="text-sm text-muted mb-2">DAY STREAK</p>
          ...
          <div className="bg-main-bg rounded-xl p-6 shadow-sm border border-border">
            <p className="text-sm text-muted mb-2">RANK</p>
        ...
        <div className="bg-main-bg rounded-xl p-6 shadow-sm mb-8 border border-border">
          <h2 className="text-xl font-bold text-heading mb-4">Current Progress</h2>
          {learningProgress && (
            <div>
        ...
        <div className="bg-main-bg rounded-xl p-6 shadow-sm mb-8 border border-border">
          <h2 className="text-xl font-bold text-heading mb-4">Badge Collection</h2>
          {badgesData && badgesData.length > 0 ? (
            ...
            <p className="text-muted">No badges yet. Complete lessons to unlock badges!</p>
          )}
            ...
            <section className="w-full max-w-7xl mx-auto px-8 pt-20 pb-24 grid lg:grid-cols-2 gap-16 items-center">
              <div className="flex flex-col space-y-8 z-10">
                ...
                <div className="flex flex-col sm:flex-row gap-4 pt-2">
                  ...
                  <Link
                    to={ROUTES.REGISTER}
                    className="px-8 py-4 bg-main-bg text-heading border border-border rounded-lg text-center text-sm font-bold hover:bg-surface transition-colors shadow-sm"
                  >
                    Sign Up
                  </Link>
                </div>
              ...
              <div className="relative mt-8 lg:mt-0 w-full max-w-lg mx-auto lg:ml-auto select-none">
                ...
                <div className="absolute -bottom-10 -right-4 md:-right-10 bg-main-bg p-5 rounded-xl shadow-[0_20px_50px_-12px_rgba(0,0,0,0.15)] border border-border w-64 z-20">
                  ...
                  <div className="w-full h-10 bg-surface rounded-lg mb-3 flex items-center justify-center">
              ...
              <div className="max-w-7xl mx-auto px-8">
                ...
                <div className="grid md:grid-cols-3 gap-8">
                  {[
                    ...
                    <div
                      key={item.label}
                      className="group bg-main-bg rounded-xl p-8 border-t-2 border-border shadow-sm transition-all duration-300 hover:-translate-y-2 flex flex-col h-full cursor-pointer"
                    ...
                    >
                      ...
                      <p className="text-sm text-muted leading-relaxed font-medium mb-8 flex-grow">
                        {item.text}
                      </p>
                      <Link
                        to={ROUTES.LEARNING_PATH}
